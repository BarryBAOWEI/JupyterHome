...
### 时段1 负周四效应 风险因素66、情绪因素48、政策因素102 00-11 
### 时段2 负周五效应 风险因素67、情绪因素49、政策因素103 00-11
### 时段3 正周二效应 风险因素65、情绪因素47、政策因素101 00-11

#### 周内效应-ged ####
spec2 = ugarchspec(
  variance.model = list(model = "realGARCH", garchOrder = c(1,1)), 
  mean.model = list(armaOrder = c(0,0), include.mean = TRUE, external.regressors =as.matrix.data.frame(sample.testc[,c(16,17,19,20,66)])), 
  distribution.model = "ged")
...
### 时段1 正二月效应   风险因素69、情绪因素51、政策因素105 00-22
### 时段2 负一月效应   风险因素68、情绪因素50、政策因素104 00-11
### 时段3 负十二月效应 风险因素71、情绪因素53、政策因素107 00-11

#### 月内效应-ged
spec8 = ugarchspec(
  variance.model = list(model = "realGARCH", garchOrder = c(5,5)), 
  mean.model = list(armaOrder = c(1,1), include.mean = TRUE, external.regressors = as.matrix.data.frame(sample.testc[,c(4:8,10:15,68)])), 
  distribution.model = "ged")
...
### 时段1 无
### 时段2 正 风险因素72、情绪因素54、政策因素108 00-11
### 时段3 无
